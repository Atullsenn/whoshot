            ...
            <div className="page-wrapper">
                ...
                <div className="container-fluid">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="white-box analytics-info">
                                <h3 className="box-title">Active Hunters</h3>
                                <ul className="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                ...
                <footer className="footer-responsivee" style={{padding: '20px',fontWeight: '500', textAlign: 'center',color: '#912c00', backgroundColor: '#fff', letterSpacing: '2px', textDecoration: 'underline'}}> © 2023 Who Shot, LLC. All rights reserved.
                </footer>
            </div>
        </>
    )
